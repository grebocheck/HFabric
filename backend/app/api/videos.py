...
from .contracts import ERROR_RESPONSES, DeleteOut, binary_response
...
@router.delete("/{video_id}", response_model=DeleteOut)
...
@router.get(
    ...
    responses=binary_response("video/mp4", "Generated MP4 video"),
)
...
@router.get(
    "/{video_id}/poster",
    response_class=FileResponse,
    responses=binary_response("image/webp", "Generated video poster"),
)
...
@router.get(
    "/{video_id}/thumb",
    response_class=FileResponse,
    responses=binary_response("image/webp", "Generated video thumbnail"),
)
